...
import com.compang.annotations.Benchmark;
import com.compang.annotations.Measurement;
import com.compang.annotations.Warmup;
...
public class CasesLoader {
    public CasesRunner load() throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        String pkg = "com/compang/cases";//在此包下加载所有的类
        String pkgDot = "com.compang.cases";
